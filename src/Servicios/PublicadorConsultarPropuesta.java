...
import DtServicios.DtListRecomendaciones;
...
public class PublicadorConsultarPropuesta {
    ...
    @WebMethod
    public DtListRecomendaciones recomendacionDePropuestas(@WebParam(name = "Nick") String Nick) {
        return new DtListRecomendaciones(Fabrica.getInstance().getControladorPropCat().recomendacionDePropuestas(Nick));
    }
}
